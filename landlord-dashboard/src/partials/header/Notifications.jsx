          ...
          <ul>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">💸 <span className="font-medium text-slate-800">Rushabh Bhansali has made a payment!</span> Click here to check transaction details.</span>
                <span className="block text-xs font-medium text-slate-400">Oct 8, 2022</span>
              </Link>
            </li>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800">Jeremy Ryu has been added as your tenant!</span> Click here to view property details and tenant information.</span>
                <span className="block text-xs font-medium text-slate-400">Aug 31, 2022</span>
              </Link>
            </li>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">🚀 <span className="font-medium text-slate-800">Welcome to Certably, A zero deposit solution for small to mid-sized property managers!</span></span>
                <span className="block text-xs font-medium text-slate-400">Aug 15, 2022</span>
              </Link>
            </li>
          </ul>
        </div>
