...
import LOGO from '/Users/jeremyryu/tailwind-dashboard-template/src/images/LOGO.svg'
        ...
        <div className="space-y-8">
          ...
          <div>
            <ul className="mt-3">
              ...
              {/* Properties */}
              <SidebarLinkGroup activecondition={pathname.includes('properties')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              ...
                              />
                              <path
                                className={`fill-current text-slate-700 ${pathname.includes('properties') && '!text-indigo-600'}`}
                                d="M13 15L0 7v9c0 .355.189.685.496.864L13 24v-9z"
                              />
                              <path
                                className={`fill-current text-slate-600 ${pathname.includes('properties') && 'text-indigo-500'}`}
              ...
              {/* Account Info */}
              <SidebarLinkGroup activecondition={pathname.includes('accountinfo')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                          pathname.includes('accountinfo') && 'hover:text-slate-200'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded ? handleClick() : setSidebarExpanded(true);
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <path
                                className={`fill-current text-slate-600 ${pathname.includes('accountinfo') && 'text-indigo-500'}`}
                                d="M18.974 8H22a2 2 0 012 2v6h-2v5a1 1 0 01-1 1h-2a1 1 0 01-1-1v-5h-2v-6a2 2 0 012-2h.974zM20 7a2 2 0 11-.001-3.999A2 2 0 0120 7zM2.974 8H6a2 2 0 012 2v6H6v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5H0v-6a2 2 0 012-2h.974zM4 7a2 2 0 11-.001-3.999A2 2 0 014 7z"
                              />
                              <path
                                className={`fill-current text-slate-400 ${pathname.includes('accountinfo') && 'text-indigo-300'}`}
