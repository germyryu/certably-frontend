...
function DashboardCard12() {
  return (
    <div className="col-span-full xl:col-span-6 bg-white shadow-lg rounded-sm border border-slate-200 h-80">
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-slate-800 hover:text-slate-900" href="#0">Rushabh Bhansali</a> made a new <a className="font-medium text-slate-800" href="#0">payment</a></div>
          ...
          <ul className="my-1">
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-slate-800 hover:text-slate-900" href="#0">3 tenants</a> have renewed leases <a className="font-medium text-slate-800" href="#0"></a></div>
                  <div className="shrink-0 self-end ml-2">
                    <a className="font-medium text-indigo-500 hover:text-indigo-600" href="#0">View<span className="hidden sm:inline"> -&gt;</span></a>
                  </div>
                </div>
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center">The property <a className="font-medium text-slate-800" href="#0">Property Name</a> needs attention by <a className="font-medium text-slate-800 hover:text-slate-900" href="#0">Jeremy Ryu</a></div>
                  <div className="shrink-0 self-end ml-2">
                    <a className="font-medium text-indigo-500 hover:text-indigo-600" href="#0">View<span className="hidden sm:inline"> -&gt;</span></a>
                  </div>
                </div>
